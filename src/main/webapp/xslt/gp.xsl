					...
					<span
						...
						<xsl:choose>
							<xsl:when
								...
								<xsl:variable
									name="prvVar">./api?inv=<xsl:value-of
							...
							<xsl:otherwise>
								<xsl:variable
									name="prvVar">./api?request=GetPassagePlus&amp;withXSLT=chs-gp&amp;urn=<xsl:value-of
										select="cts:contextback"/>&amp;context=<xsl:value-of select="$ctxt"/></xsl:variable>
								<xsl:element
									name="a">
									<xsl:attribute
						...
						<xsl:choose>
							<xsl:when
								...
								<xsl:variable
									name="nxtVar">./api?inv=<xsl:value-of
										select="$inv"/>&amp;request=GetPassagePlus&amp;withXSLT=chs-gp&amp;urn=<xsl:value-of
							...
							<xsl:otherwise>
								<xsl:variable
									name="nxtVar">./api?request=GetPassagePlus&amp;withXSLT=chs-gp&amp;urn=<xsl:value-of
										select="cts:contextforward"/>&amp;context=<xsl:value-of select="$ctxt"/></xsl:variable>
								<xsl:element
									name="a">
									<xsl:attribute
